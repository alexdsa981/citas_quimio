    ...
    try {
        ...
        cuerpoTabla.querySelectorAll('.btn-agregar').forEach(btn => {
            btn.addEventListener('click', async function () {
                ...
                try {
                    const response = await fetch('/app/personal/medico/guardar', {
                        method: 'POST',
                        headers: {
                    ...
                    if (!response.ok) throw new Error('Error al guardar médico');
                    ...
                    Swal.fire({
                        ...
                        text: 'El médico fue agregado o actualizado correctamente.',
                        timer: 2000,
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Hubo un problema al agregar el médico.',
                    });
                }
            });
        });
